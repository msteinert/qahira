...
#define GET_PRIVATE(instance) \
	((struct Private *)((QahiraLoaderTarga *)instance)->priv)
...
static void
qahira_loader_targa_init(QahiraLoaderTarga *self)
{
...
finalize(GObject *base)
{
	...
	G_OBJECT_CLASS(qahira_loader_targa_parent_class)->finalize(base);
}
...
static void
qahira_loader_targa_class_init(QahiraLoaderTargaClass *klass)
{
...
{
	return g_object_new(QAHIRA_TYPE_LOADER_TARGA, NULL);
}
