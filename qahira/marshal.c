...
void
qahira_marshal_POINTER__INT_INT_INT (GClosure     *closure,
...
{
  typedef gpointer (*GMarshalFunc_POINTER__INT_INT_INT) (gpointer     data1,
                                                         gint         arg_1,
                                                         gint         arg_2,
                                                         gint         arg_3,
                                                         gpointer     data2);
  register GMarshalFunc_POINTER__INT_INT_INT callback;
  ...
  callback = (GMarshalFunc_POINTER__INT_INT_INT) (marshal_data ? marshal_data : cc->callback);
...
void
qahira_marshal_POINTER__POINTER (GClosure     *closure,
                                 GValue       *return_value G_GNUC_UNUSED,
                                 guint         n_param_values,
                                 const GValue *param_values,
                                 gpointer      invocation_hint G_GNUC_UNUSED,
...
void
qahira_marshal_INT__POINTER (GClosure     *closure,
                             GValue       *return_value G_GNUC_UNUSED,
                             guint         n_param_values,
                             const GValue *param_values,
                             gpointer      invocation_hint G_GNUC_UNUSED,
...
void
qahira_marshal_OBJECT__STRING (GClosure     *closure,
                               GValue       *return_value G_GNUC_UNUSED,
                               guint         n_param_values,
                               const GValue *param_values,
                               gpointer      invocation_hint G_GNUC_UNUSED,
